 ...
 */
class User extends \Annonces\BackendBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Annonces\\BackendBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Annonces\\BackendBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'Annonces\\BackendBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Annonces\\BackendBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Annonces\\BackendBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'Annonces\\BackendBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Annonces\\BackendBundle\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'Annonces\\BackendBundle\\Entity\\User' . "\0" . 'salt');
        }
