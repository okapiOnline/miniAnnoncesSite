...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'annonces', 'user' => 'root', 'password' => 'password', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Annonces\\BlogBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Annonces\\BackendBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Annonces\\BlogBundle\\Entity');
        $c->addDriver($b, 'Annonces\\BackendBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AnnoncesBlogBundle' => 'Annonces\\BlogBundle\\Entity', 'AnnoncesBackendBundle' => 'Annonces\\BackendBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e4a5d37cbf7595e90450f0110421ed624f024d4234f63f40e72ee71a66739e68');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Annonces\\BackendBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 12))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/private');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/dashboard');
        ...
        $k->add($i, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_ADMIN'), NULL);
        $k->add($j, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_ADMIN'), NULL);

        $l = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, '/connexion'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $l, 'secured_area', $n, $o, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58ce2747d0dff6.52268477', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, '/connexion', false), NULL, NULL, $a, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('yourmail@domaine.fr');
        $a->setPassword(NULL);
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Annonces\\BlogBundle/Resources/views'), 'AnnoncesBlog');
        $instance->addPath(($this->targetDirs[3].'\\src\\Annonces\\BackendBundle/Resources/views'), 'AnnoncesBackend');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ThisTokenIsNotSoSecretChangeItWhenYouAreReady');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Annonces\\BackendBundle\\Entity\\User', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AnnoncesBlogBundle' => 'Annonces\\BlogBundle\\AnnoncesBlogBundle',
                'AnnoncesBackendBundle' => 'Annonces\\BackendBundle\\AnnoncesBackendBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'AnnoncesBlogBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Annonces\\BlogBundle'),
                    'namespace' => 'Annonces\\BlogBundle',
                ),
                'AnnoncesBackendBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Annonces\\BackendBundle'),
                    'namespace' => 'Annonces\\BackendBundle',
                ),
                'StofDoctrineExtensionsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\stof\\doctrine-extensions-bundle\\Stof\\DoctrineExtensionsBundle'),
            ...
            'database_port' => NULL,
            'database_name' => 'annonces',
            'database_user' => 'root',
            'database_password' => 'password',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'yourmail@domaine.fr',
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeItWhenYouAreReady',
            'locale' => 'en',
            'annonces_blog.emails.contact_email' => 'kimkayna@gmail.com',
            ...
            'kernel.secret' => 'ThisTokenIsNotSoSecretChangeItWhenYouAreReady',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'yourmail@domaine.fr',
